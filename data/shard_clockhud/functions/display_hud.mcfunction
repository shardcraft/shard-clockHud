...
execute as @a[tag=isHoldingClock,scores={daytime=13670..22331}] run title @s actionbar ["",{"text":"Daytime: ","color":"gold"},{"color":"white","score":{"name":"*","objective":"daytime"}},{"text":" ☽","color":"blue"}]
execute as @a[tag=isHoldingClock,scores={daytime=22331..23460}] run title @s actionbar ["",{"text":"Daytime: ","color":"gold"},{"color":"white","score":{"name":"*","objective":"daytime"}},{"text":" ●","color":"red"}]
